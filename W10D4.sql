...
OraArr time,
TipoAereo varchar(100) FOREIGN KEY REFERENCES AEREO (TipoAereo));

CREATE TABLE AEREO
(TipoAereo varchar (100) PRIMARY KEY (TipoAereo),
NumPasseggeri integer,
QtaMerci numeric (5,00));
...
('Boing771', '3', '100.00'),
('Deltaplano', '50', '2.00'),
('Mongolfiera', '4', '1000.00'),
('Slitta con le renne', '2', '10000.00'),
('Elicottero', '6', '20.00');
