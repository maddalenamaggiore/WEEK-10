...
CREATE TABLE VOLO
(
IdVolo varchar (100),GiornoSett date,CittaPart varchar (100),OraPart time,CittaArr varchar (100),OraArr time,TipoAereo varchar(100)
);
CREATE TABLE AEREO
(
...
--Il tipo di aereo, il giorno della settimana,
--l’orario di partenza la cui città di partenza inizia per B e contiene O e la cui città di arrivo termina con A e contiene E
